...
$string['completioncomments'] = 'Student must add comments:';
$string['completioncommentsdesc'] = 'Student must add at least {$a} comment(s)';
$string['completioncommentsgroup'] = 'Require comments';
$string['completiondetail:comments'] = 'Add comments: {$a}';
$string['completiondetail:galleries'] = 'Add galleries: {$a}';
$string['completiondetail:items'] = 'Add items: {$a}';
$string['completiongalleries'] = 'Student must add galleries:';
$string['completiongalleriesdesc'] = 'Student must add at least {$a} gallery/galleries';
$string['completiongalleriesgroup'] = 'Require galleries';
$string['completionitems'] = 'Student must add items:';
$string['completionitemsdesc'] = 'Student must add at least {$a} item(s)';
$string['completionitemsgroup'] = 'Require items';
